    ...
    <AuthLayout>
      <AuthCard>
        <div className="text-center">
          ...
          <a href="/auth/signin" className="inline-flex w-full justify-center rounded-xl bg-brand hover:bg-brand/90 text-white py-3 text-sm font-medium transition-colors">
            Log in
          </a>
        </div>
      </AuthCard>
