          ...
          <div className="flex-1">
            ...
            {metadata && (
              <p className="text-sm text-gray-600 mt-1">
                Found {metadata.total} result{metadata.total !== 1 ? "s" : ""}{" "}
                for "{query}"
        ...
        {advancedSearchEnabled && (
          ...
          >
            ...
            <div className="flex-1 text-sm text-purple-900">
              <span className="font-medium">Advanced Search Enabled:</span>{" "}
              Searching deeper into course descriptions, metadata, and related
              materials for more comprehensive results.
            </div>
          </motion.div>
        )}
      </div>
      ...
      {isSearching && (
        <div className="flex items-center justify-center py-20">
          <div className="text-center">
            ...
            <p className="text-gray-600 font-medium">Searching materials...</p>
