...
import { Course, getCourseById, updateCourse, deleteCourse, unlinkCourseToDepartment, UpdateCourseRequest } from "@/api/course.api";
...
const CourseModal: React.FC<CourseModalProps> = ({
  ...
  return (
    <>
      <Dialog open={isOpen && !(showDeleteDialog || showUnlinkDialog.show)} onOpenChange={onClose}>
                ...
                <div className="space-y-8 order-2 lg:order-1 lg:col-span-2">
                  {showEditForm ? (
                    ...
                    <div className="bg-white shadow-sm p-6 border rounded-xl">
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          <h3 className="mb-2 font-semibold text-lg">Course Details</h3>
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            ...
                            <Badge
                              variant={course.reviewStatus === "approved" ? "default" : "secondary"}
                              className={
                  ...
                  <div className="bg-white shadow-sm p-6 border rounded-xl">
                    <div className="flex justify-between items-center mb-6">
                      <h3 className="font-semibold text-lg">Department Offerings</h3>
                      <Button
                        size="sm"
                        ...
                        <div className="gap-4 grid grid-cols-1 md:grid-cols-2">
                          {course.departments.map((dept) => (
                            <div
                              ...
                              className="flex justify-between items-center bg-gray-50 p-4 border rounded-xl"
                            >
                              <div>
                              ...
                              <div className="flex items-center gap-2">
                                <Badge
                                  variant={dept.reviewStatus === "approved" ? "default" : "secondary"}
                                  className={
                                ...
                                <Button
                                  ...
                                  onClick={() => handleUnlinkClick(dept.departmentId)}
                                >
                  ...
                  <div className="bg-white shadow-sm p-6 border rounded-xl">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                        <span className="text-muted-foreground text-sm">Total Departments</span>
                        <span className="font-medium text-lg">
                          {course.departments?.length || 0}
                        </span>
                      </div>
                      <div className="flex justify-between items-center bg-green-50 p-3 rounded-lg">
                        <span className="text-green-600 text-sm">Approved Links</span>
                        <span className="font-medium text-green-600 text-lg">
                          {course.departments?.filter((d) => d.reviewStatus === "approved").length || 0}
                        </span>
                      </div>
                      <div className="flex justify-between items-center bg-amber-50 p-3 rounded-lg">
                        <span className="text-amber-600 text-sm">Pending Links</span>
                        <span className="font-medium text-amber-600 text-lg">
                          {course.departments?.filter((d) => d.reviewStatus === "pending").length || 0}
                        </span>
                      </div>
                    </div>
                  </div>
      ...
      <AlertDialog
        ...
        onOpenChange={(open) => setShowUnlinkDialog({ ...showUnlinkDialog, show: open })}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction
              onClick={() => handleUnlinkDepartment(showUnlinkDialog.departmentId)}
              className="bg-red-500 hover:bg-red-600"
            >
              Unlink
            </AlertDialogAction>
