...
const HeroSection: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Dashboard preview image - not inside a container and no extra chrome */}
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -z-0 inset-x-0 top-0 h-48"
        style={{ background: `linear-gradient(180deg, ${NAV_BRAND_COLOR}10, transparent)` }}
      />
    </section>
  );
};
