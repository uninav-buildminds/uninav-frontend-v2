...
export const COURSE_CODE_PREFIXES: Record<string, string[]> = {
  ...
  ESC: ['EDUCATION AND SCIENCE TEACHING'],
...
export const DEPARTMENT_NAMES: Record<string, string[]> = {
  ...
  'PETROLEUM ENGINEERING': ['PETRO ENG', 'PTE', 'PETROLEUM'],
  ...
  'INTERNATIONAL RELATIONS': ['INT RELATIONS', 'INR', 'INTL RELATIONS'],
  ...
  'ISLAMIC RELIGIOUS STUDIES': ['ISS', 'ISLAMIC STUDIES'],
  'FINE ARTS': ['FINE ART', 'FNA', 'VISUAL ARTS'],
  'CREATIVE ARTS': ['ART', 'ARTS'],
  ARCHAEOLOGY: ['ARH', 'ARCHAEO', 'ARCHEOLOGY'],
  ...
  'EDUCATION AND SCIENCE TEACHING': ['SCIENCE TEACHING', 'ESC', 'ED SCIENCE'],
